...
const goMoleUrl = "https://go.dev/blog/go-brand/Go-Logo/PNG/Go-Logo_Blue.png"
const phpMoleUrl = "https://www.php.net/images/logos/php-logo-bigger.png"
const getLogo = (type) => {
  switch (type) {
    case "go":
      return (<image xlinkHref={goMoleUrl}
             x="45.5" y="130" height="100" width="100" preserveAspectRatio="none"/>)
    case "php":
      return (<image xlinkHref={phpMoleUrl}
                     x="65" y="160" height="40" width="70" preserveAspectRatio="none"/>)
    default:
      return null
  }
}
const Mole = ({
  ...
  const logoRef = useRef(getLogo(type))
  ...
  const whack = (e) => {
    ...
    onWhack(pointsRef.current, pointsRef.current > constants.GOLDEN_SCORE * 0.5, nameRef.current)
  }
